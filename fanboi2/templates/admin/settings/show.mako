...
<div class="sheet-body">
    <p>Enter a <strong>valid JSON</strong> and press update. Settings cache will be invalidated and changes will be applied immediately. Please make sure the settings is in the correct format before proceeding.</p>
</div>
<form class="form noshade" action="${request.route_path('admin_setting', setting=key)}" method="post">
    ...
    <div class="form-item">
        <button class="button brand" type="submit">Update</button>
    </div>
</form>