...
<div class="panel">
    <div class="container u-pd-vertical-xl">
        <h2 class="panel__item u-mg-bottom-xs u-txt-brand">Processing topic...</h2>
        <p class="panel__item u-mg-bottom-xs">Your topic is currently processing. You will be redirected automatically.</p>
