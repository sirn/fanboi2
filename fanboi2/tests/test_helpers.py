...
class TestFormatters(unittest.TestCase):
    ...
    def test_format_markdown(self):
        ...
        for source, target in tests:
            self.assertEqual(
                format_markdown(None, self.request, source),
                Markup(target))
    ...
    def test_format_datetime(self):
        ...
        self.assertEqual(
            format_datetime(None, request, d1),
            "Jan 02, 2013 at 07:04:01")
        self.assertEqual(
            format_datetime(None, request, d2),
    ...
    def test_format_isotime(self):
        ...
        self.assertEqual(
            format_isotime(None, self.request, d1),
    ...
    def test_format_post(self):
        ...
        for source, target in tests:
            self.assertEqual(
                format_post(None, self.request, source),
                Markup(target))
